...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen min-h-[100svh] bg-gray-950 text-white p-4 sm:p-8 pt-[calc(1.25rem+env(safe-area-inset-top,0px))] pb-[calc(2.5rem+env(safe-area-inset-bottom,0px))] sm:pt-8 sm:pb-8">
